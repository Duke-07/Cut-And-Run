class Game{
    constructor(){
        ...
        this.velocity = -10;
        this.gameIconImg = loadImage("images/cut and run.jpg");
        this.gameIcon = createSprite(width/2-200,height/2-200)
        this.gameIcon.addImage(this.gameIconImg);

        this.winMusic = loadSound("sound/youwin.mp3");
        this.deathMusic = loadSound("sound/death.mp3");
        this.gameSound = loadSound("sound/sound play.mp3");
        this.clickSound = loadSound("sound/mouse click.mp3");
    }
    start(){
        textSize(20);
        textFont("Amsterdam");
        stroke("white");
        fill("black");
        text ("Game By Aaryan Dwivedi a.k.a Chronicle",width/2+100,height/2-200);
        ...
        text("You also have magical power of flying...", width/2-300,height/2+200)
    ...
    win(){
        ...
        this.wolfGroup.destroyEach();
        this.castle.destroy();
        text("Thanks for playing... Have a great day ahead.", width/2-300,height/2+150);
    }
    spawnWolf(){
